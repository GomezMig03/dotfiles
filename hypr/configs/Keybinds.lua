...
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd(scriptsDir .. "/ToggleLayout.sh"))
...
-- Scrolling Layout
hl.bind(mainMod .. " + mouse_down", hl.dsp.focus({ direction = "up" }))
hl.bind(mainMod .. " + mouse_up", hl.dsp.focus({ direction = "down" }))
...
-- TODO: manual review on line 41 — changegroupactive: expected 'f', 'b', or an index (got "")
